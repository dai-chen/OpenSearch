...
public class OpenSearchExprGeoPointValue extends AbstractExprValue {
    ...
    public Point valueForCalcite() {
        ...
        return GeometryUtils.defaultFactory.createPoint(new Coordinate(this.geoPoint.lon, this.geoPoint.lat));
    }
    ...
    public int compare(ExprValue other) {
        return geoPoint.toString().compareTo((((OpenSearchExprGeoPointValue) other).geoPoint).toString());
    }

...
/**
 * REST handler for POST /_sql endpoint.
 *
 * @opensearch.internal
 */
public class RestSqlAction extends BaseRestHandler {

    /** Creates a new RestSqlAction. */
    public RestSqlAction() {}

    @Override
    public String getName() {
        return "query_languages_sql_action";
    }

    @Override
    public List<Route> routes() {
        return singletonList(new Route(POST, "/_sql"));
    }
    ...
    protected RestChannelConsumer prepareRequest(RestRequest request, NodeClient client) throws IOException {
        ...
        QueryLanguageRequest langRequest = new QueryLanguageRequest(query, QueryType.SQL);

...
import org.opensearch.querylanguages.opensearch.data.value.OpenSearchExprGeoPointValue;
...
public class JdbcOpenSearchDataTypeConvertor {
    ...
    /**
     * Converts SQL value to ExprValue.
     ...
     */
    public static ExprValue getExprValueFromSqlType(ResultSet rs, int i, int sqlType, RelDataType fieldType, String fieldName)
        throws SQLException {
        ...
        try {
            switch (sqlType) {
                ...
                default:
                    LOG.debug("Unchecked sql type: {}, return Object type {}", sqlType, value.getClass().getTypeName());

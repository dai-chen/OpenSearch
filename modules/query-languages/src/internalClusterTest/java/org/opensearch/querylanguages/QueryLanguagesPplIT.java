...
/**
 * Integration test for the PPL endpoint.
 */
public class QueryLanguagesPplIT extends OpenSearchIntegTestCase {
    ...
    /**
     * Test PPL query: index documents, query via transport action, verify results.
     *
     * @throws Exception if query execution fails
     */
    public void testPplQuery() throws Exception {
        String index = "test_ppl";
        ...
        // Execute PPL query via transport action
        QueryLanguageRequest request = new QueryLanguageRequest("source = " + index + " | where age > 21", QueryType.PPL);
